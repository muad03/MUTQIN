...
class WeeklyTestController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // قرار تصميمي معتمد: تكرار الاختبارات الأسبوعية «حر» عمداً — لا قيد فريد
        // ولا أي فحص تكرار. الأصل أن الاختبار يوم السبت، لكن بعض الطلاب لهم
        // استثناء ويُختبرون في يوم آخر (وقد يُعاد اختبار الطالب في نفس الأسبوع
        // أو حتى في نفس اليوم) — فكل اختبار سجلٌّ مستقل بأسئلته، يُضاف مباشرة
        // بلا تنبيه ولا تأكيد. (يقابله في الحضور العكس: سجل واحد لليوم بتأكيد.)
